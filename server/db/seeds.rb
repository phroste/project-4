...
curryRice = Recipe.create!([
  {name: "Homemade Japanese Curry Rice", instructions: [
...
Ingredient.create!([
  {name: ["For the Curry Spice Blend:",
  ...
  "Pickled ginger and/or rakkyo (pickled Japanese scallion), for serving" ], recipe_id: 2}
]);

Ingredient.create!([
  {name: ["1 (4-pound; 1.8kg) whole chicken", "3 quarts (2.8L) cold or room-temperature homemade chicken stock or store-bought low-sodium chicken broth", "6 medium cloves garlic", "2 sprigs fresh thyme", "1 bay leaf", "1 large carrot (8 ounces; 230g), diced", "1 medium turnip (7 ounces; 200g), peeled and diced", "1 medium yellow onion (9 ounces; 250g) or large leek (white and light green parts only), diced", "1 large parsnip (10 ounces; 285g), peeled and diced", "2 medium ribs celery (5 ounces; 150g), diced", "Kosher salt and freshly ground black pepper", "Minced fresh dill, flat-leaf parsley, or other fresh herbs, to finish"], recipe_id: 3}
]); 

Ingredient.create!([
  {name: ["1 tablespoon (15ml) extra-virgin olive oil", "6 ounces (170g) guanciale, cut into slices about 1/8 inch thick and then into 3/4- by 1/4-inch strips", "Pinch red pepper flakes", "1/4 cup (60ml) dry white wine", "1 (15-ounce; 425g) can whole peeled tomatoes, preferably San Marzano, crushed by hand", "Kosher salt and freshly ground black pepper", "1 pound (450g) dried bucatini pasta", "1 ounce (30g) grated Pecorino Romano cheese, plus more for serving"], recipe_id: 4}
]);

Ingredient.create!([
  {name: ["3 strips thick-cut, naturally cured bacon", "2 slices high-quality sandwich bread, such as shokupan", "2 tablespoons (30ml) homemade or store-bought mayonnaise", "1 1/2 cups finely shredded iceberg lettuce", "4 thick slices ripe tomato", "Coarse sea salt, such as fleur de sel or Maldon", "Freshly ground black pepper"], recipe_id: 5 }
]);

Ingredient.create!([
  {name: ["1 1/4 pound red cherries (565g), halved and pitted", "1 pound jicama (from 1 jicama root; about 450g); peeled and cut into batons", "1 small handful torn fresh basil leaves", "4 ounces macadamia nuts (110g), roughly crushed", "Zest of 1 lime plus fresh lime juice to taste (from 1 to 2 limes)", "Extra-virgin olive oil, for drizzling", "Kosher salt"], recipe_id: 6}
]);

Ingredient.create!([
  {name: ["3 pounds seedless watermelon (about 1 small or 1/4 large), rind removed, cut into 1-inch chunks (about 2 pounds/1kg chunks after rind is discarded)", "1 tablespoon (15ml) juice from 1 lemon, plus 4 (2-inch) strips zest, removed with a sharp vegetable peeler", "3 tablespoons (45ml) extra-virgin olive oil, plus more for drizzling", "1/4 cup (10g) roughly chopped fresh mint leaves", "Up to 4 ounces (1 quart) arugula leaves (optional)", "Kosher salt and freshly ground black pepper", "4 ounces (110g) feta cheese"], recipe_id: 7}
]);

Ingredient.create!([
  {name: ["Basic Dry Pancake Mix:", "10 ounces (about 2 cups) all purpose flour", "1 teaspoon baking powder", "1/2 teaspoon baking soda", "1 teaspoon kosher salt", "1 tablespoon sugar", "For Each Batch of Pancakes", "2 large eggs, separated", "1 1/2 cups (about 12 ounces) buttermilk", "1 cup (about 8 ounces) sour cream", "4 tablespoons unsalted butter, melted, plus more for serving", "Warm maple syrup"], recipe_id: 8}
]);  

Ingredient.create!([
  {name: ["3 tablespoons butter", "2 (1/2-inch thick) slices pineapple, about 2- by 4-inches each", "2 slices ham", "2 slices hearty white bread, such as Pepperidge Farm or Arnold, or 2 slices hearty French or Italian bread", "2 slices Swiss cheese", "Kosher salt"], recipe_id: 9}
]);

Ingredient.create!([
  {name: ["1 cup cooked hot white rice (about 12 ounces cooked rice; 340g)", "1 egg (plus 1 optional egg yolk)", "Soy sauce", "Kosher salt", "MSG powder, such as Aji-no-moto or Accent", "Mirin (optional)", "Hondashi (optional)", "Furikake (optional)", "Thinly sliced or torn nori (optional)"], recipe_id: 10 }
]);

Ingredient.create!([
  {name: ["1/2 pound ground pork", "1/2 teaspoon minced fresh ginger", "1/2 teaspoon minced garlic (about 1 small clove)", "1 teaspoon Shaoxing wine", "Kosher salt", "1/4 teaspoon sugar", "1/2 teaspoon soy sauce", "1 1/2 teaspoons cornstarch", "2 teaspoons vegetable or canola oil", "2 scallions, chopped (optional)", "6 cups water", "1/2 cup short grain rice, washed and drained", "About 1 cup corn kernels cut from 1 large ear of corn"], recipe_id: 11}
]);

Ingredient.create!([
  {name: ["Kosher salt", "12 ounces Shanghai baby bok choy, split in half", "2 teaspoons soy sauce", "1/8 teaspoon white pepper powder", "1 teaspoon sesame oil", "2 teaspoon cornstarch", "3 tablespoon water", "2 tablespoons vegetable, peanut, or canola oil", "1 tablespoon fermented black bean", "6 medium cloves garlic, roughly chopped"], recipe_id: 12} 
]); 
